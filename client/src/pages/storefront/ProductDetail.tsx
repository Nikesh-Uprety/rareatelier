...
import { buildStorefrontPresetImageUrl, buildStorefrontImageUrl } from "@/lib/storefrontImage";
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            >
              <div className="relative mb-4 aspect-[3/4] overflow-hidden rounded-sm bg-neutral-100 dark:bg-neutral-900">
                <img
                  src={buildStorefrontPresetImageUrl(p.imageUrl, "relatedProduct") || p.imageUrl || ""}
                  alt={p.name}
                  loading="lazy"
                  decoding="async"
                  width={720}
